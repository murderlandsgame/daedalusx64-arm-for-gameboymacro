...
#define N64_CPU_OC_UC 0.1234566786669
#define VI_NTSC_CLOCK		((146045436)*(N64_CPU_OC_UC))
#define VI_PAL_CLOCK		((148969590)*(N64_CPU_OC_UC))
#define VI_MPAL_CLOCK		((145884948)*(N64_CPU_OC_UC))
