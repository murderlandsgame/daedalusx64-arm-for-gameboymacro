...
#define AI_NTSC_MAX_FREQ        ((146045436/10000)*(N64_CPU_OC_UC))
#define AI_NTSC_MIN_FREQ        ((146045436/10000)*(N64_CPU_OC_UC/3))

#define AI_PAL_MAX_FREQ         ((148969590/10000)*(N64_CPU_OC_UC))
#define AI_PAL_MIN_FREQ         ((146045436/10000)*(N64_CPU_OC_UC/3))

#define AI_MPAL_MAX_FREQ        ((145884948/10000)*(N64_CPU_OC_UC))
#define AI_MPAL_MIN_FREQ        ((146045436/10000)*(N64_CPU_OC_UC/3))
